...
|---|---|---|---|
| `development` (o no seteado en local) | Playlist Metronome (Dev) | `com.tryironflow.playlistmetronome.dev` | `com.tryironflow.playlistmetronome.dev` |
| `production` | Playlist Metronome | `com.tryironflow.playlistmetronome` | `com.tryironflow.playlistmetronome` |
